<!-- NAVIGATION BAR -->
    ...
    <nav class="navbar navbar-light" id="title">
        <a style="color: white; font-size: 1.4em; font-weight: 600; margin-left: 0px;">
            <img src="imgs/android-icon-36x36.png" class="logo-image" style="height: 42px; width: 42px; margin-right: 5px; -webkit-box-shadow: 1px 1px 5px 0px rgba(252,247,252,1);
