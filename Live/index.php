                        ...
                        <div class="info-box bg-info">
                            ...
                            <div class="info-box-content ">
                                ...
                                <select id='city' class="form-control" style="padding: 0px; margin: 0px;">
                                    ...
                                    <?php
                                    $storethis = "";
                                    $query1 = "SELECT ID, cityName from City ORDER by cityName ASC";
                                    $result1 = mysqli_query($con,$query1);
                                    while($rows3 = mysqli_fetch_array($result1))
                                    {
                                        ...
                                        {
                                            ?>
                                            <option value="<?php echo str_replace(" ","%20 ",$rows3['cityName']); ?>">
                                                <?php echo $rows3['cityName']; ?>
                                            </option>
                                            
                                            <?php
                                            $storethis=$rows3['cityName'];
                                        }
                                    }
                                    ?>
                                </select>
