...
<button onclick="recenter()" style="width: 100%;">Re-Center</button></div>
<div class="col col-lg-6 col-sm-6 col-md-6">
<button type="button" data-toggle="modal" data-target="#exampleModalCenter" style="width: 100%">Instructions</button></div>
</div>
</body>
</html>