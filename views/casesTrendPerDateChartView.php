...
$(function() {
    ...
    $("#toggleTrendCasesChart").on("click", function() {
        if(isMovingAverage){
            $("#toggleTrendCasesChart").text("SWITCH TO MOVING AVERAGE");
            isMovingAverage = false;
            lineChart.data.datasets[0] = rawData;
        }else{
            $("#toggleTrendCasesChart").text("SWITCH TO RAW DATA");
            isMovingAverage = true;
            lineChart.data.datasets[0] = movingAverageData;
