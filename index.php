   ...
   <!-- INCLUDE NAVBAR-->
    ...
    <div class="content container-fluid">
        ...
        <div class="container-fluid" >
            <div class="row">
                <div class=" col-lg-9 col-md-12 col-sm-12 text-sm">
            ...
            jQuery(function($) {  
                ...
                // Get context with jQuery - using jQuery's .get() method.
                 //$("#refreshthis").load("caserefresh.php?location=LAGUNA");
                    ...
                    $("#recoveryperdate").load("recoveryperdate.php?location=LAGUNA");
                    $("#deceasedperdate").load("deceasedperdate.php?location=LAGUNA");
                ...
                $("#city").on('change', function() {
                    ...
                    $("#divCount").load('countNew.php?location=' + city);
                      ...
                      // $('#refreshthis').load('caserefresh.php?location=' + city);
                        ...
                        $("#recoveryperdate").load("recoveryperdate.php?location=" +city);
                        $("#deceasedperdate").load("deceasedperdate.php?location=" +city);
