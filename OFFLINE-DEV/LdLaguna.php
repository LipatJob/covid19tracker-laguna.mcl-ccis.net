...
<table id="checkthistable" class="table table-bordered table-striped dataTable" role="grid">
          ...
          //fetch
          $msql9 = "SELECT Province, TOTAL_POSITIVE_CASES, NEW_POSITIVE_CASES, TOTAL_CURRENT_POSITIVE, TOTAL_RECOVERED, TOTAL_SUSPECT, TOTAL_PROBABLE, TOTAL_DECEASED FROM ALL_TOTAL";
          ...
          while ($row1 = mysqli_fetch_assoc($result1)) {
            ...
            ?>
				...
				if($testget == 'LAGUNA')
				{
					 ...
					 $result1 = mysqli_query($con,"SELECT SUM(TOTAL_POSITIVE_CASES) as POSCASES, SUM(NEW_POSITIVE_CASES) as NEWPOS, SUM(TOTAL_CURRENT_POSITIVE) as ACTIVE,SUM(TOTAL_RECOVERED) as RECOVERED,  SUM(TOTAL_SUSPECT) as PUI,SUM(TOTAL_PROBABLE) as PUM, SUM(TOTAL_DECEASED) as DECEASED FROM ALL_TOTAL");
